  ...
  factory: (require) => {
    ...
    var exports = module.exports;
      ...
      var api = {
         ...
         */
        renderPreview: (sessionId, docKey, markdown, meta) => call(
          `/render`,
          {
            method: "POST",
      ...
      function hasExternalLinks(markdown) {
      ...
      function Panel(props) {
        ...
        if (state.status === "loading") {
          return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-root", ref: rootRef, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-blank", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-blank-card", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-blank-mark", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-blank-glyph", children: "鱼" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "鱼排编辑器" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-blank-line fp-muted", children: "正在打开文档…" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-loading-bar" })
          ] }) }) });
        }
        if (state.status === "error" && !state.docKey) {
          return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-root", ref: rootRef, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-blank", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-blank-card", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-blank-line", children: [
              "面板没能载入：",
              state.error
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-blank-actions", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, { primary: true, onClick: () => void store.actions.init(), children: "重试" }) })
          ] }) }) });
        }
        if (state.status === "empty" || !state.docKey) {
          return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-root", ref: rootRef, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-blank", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-blank-card", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-blank-line fp-muted", children: [
              "这个会话还没有鱼排文档。可以让模型调用 ",
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: "fishpai_open" }),
              " 打开一篇 Markdown， 也可以自己先起一篇："
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-blank-actions", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, { primary: true, onClick: () => void store.actions.createDoc(), children: "新建空白文档" }) }),
            state.docs.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-doclist", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-doclist-head", children: "最近打开" }),
              state.docs.slice(0, 6).map((d) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "button",
                {
                  type: "button",
                  className: "fp-docrow",
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-docrow-title", children: d.title || "未命名" }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-spacer" }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-muted", children: fmtTime(d.updatedAt) })
                  ]
                },
                d.key
              ))
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-root", ref: rootRef, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-toolbar", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-row", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-spacer" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, { title: "重新载入文档（有未保存的改动会先保存，不会丢字）", onClick: () => void store.actions.reloadSafely(), children: "刷新" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, { primary: true, title: "下载「复制到公众号」形态的自包含 HTML 文件（本地图片已内嵌 base64）", onClick: () => void onExport(), children: "导出 HTML" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, { primary: true, title: `复制后直接粘进公众号编辑器（${COPY_HINT}）`, onClick: () => void onCopy(), children: "复制到公众号" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-row", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "select",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("optgroup", { label: "适合公众号", children: state.themes.filter((t) => t.wechatSafe).map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", { value: t.key, children: [
                      t.emoji,
                      " ",
                      t.name
                    ] }, t.key)) }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("optgroup", { label: "其它风格（微信可能掉样式）", children: state.themes.filter((t) => !t.wechatSafe).map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", { value: t.key, children: [
                      t.emoji,
                      " ",
                      t.name
                    ] }, t.key)) })
              ...
              currentTheme?.usesAccent ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-swatches", title: "主题色", children: [
          ...
          currentTheme && !currentTheme.wechatSafe ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-banner", "data-kind": "warn", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
          ...
          state.error ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-banner", "data-kind": "error", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-spacer" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, { onClick: () => void store.actions.reloadSafely(), children: "重试" })
          ] }) : null,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-status", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-spacer" }),
            state.images.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "span",
              {
      ...
      ${manualImages.map((i) => i.src).join("\n")}` : "本地图会内嵌成 base64，复制到公众号时跟着一起过去，不用手动重传",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "fp-muted", title: currentTheme ? currentTheme.desc : void 0, children: [
              state.themeName,
              currentTheme ? ` · ${currentTheme.wechatSafe ? "适合微信" : "导出 HTML 更稳"}` : ""
            ] })
          ] }),
          state.toast ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fp-toast", "data-kind": state.toast.kind, children: state.toast.text }) : null
        ] });
      }
      function Editor(props) {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-pane", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-pane-head", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-spacer" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-muted", children: props.currentBlock ? `${kindLabel(props.currentBlock.kind)} · 第 ${props.currentBlock.startLine} 行` : "未在块内" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "textarea",
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-drawer-body", children: [
            props.tab === "notes" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-compose", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-row", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "fp-muted", children: [
                    MOD_KEY,
                    " + Enter 添加"
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-spacer" }),
              ...
              props.notes.map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-item", "data-orphan": n.orphan ? "true" : void 0, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-item-head", children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "fp-spacer" }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, { onClick: () => props.onJumpNote(n), title: "跳到引用它的那段并选中", children: "定位" }),
            ...
            props.tab === "blocks" ? props.blocks.map((b) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-item", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fp-item-head", title: `block_id: ${b.id}`, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
                  "第 ",
                  b.index + 1,
                  " 块"
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: kindLabel(b.kind) }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
                  "第 ",
                  b.startLine,
                  " 行"
      ...
      function apply(ctx) {
        ...
        function Title() {
          return React2.createElement("span", { className: "fp-title-label" }, "鱼排编辑器");
        }
